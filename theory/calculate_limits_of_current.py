...
transformation_ratio = load_current / secundary_rms_voltage
...
print(f"Secundary peak voltage: {secundary_peak_voltage:.5f} V")
print(f"Secundary peak to peak voltage: {secundary_peak_to_peak_voltage:.5f} V")
