...
#define WAVE_C_VOLTAGE_CHANNEL      ADC1_CHANNEL_6
#define WAVE_A_CURRENT_CHANNEL      ADC1_CHANNEL_5
#define WAVE_B_CURRENT_CHANNEL      ADC1_CHANNEL_7
#define WAVE_C_CURRENT_CHANNEL      ADC1_CHANNEL_9
#define WAVE_N_CURRENT_CHANNEL      ADC1_CHANNEL_8
