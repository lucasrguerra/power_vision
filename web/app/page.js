                ...
                <div className="mx-4">
                    ...
                    <div className="md:w-8/12 mx-auto">
                        ...
                        <p className="text-center pb-8">
                            The project was developed as a Course Completion Work for the Computer Science course at the Federal Rural
                            University of Pernmabuco (UFRPE) and guided by Prof. Dr. Abner Corrêa Barros. The project's main objective is
                            to implement a low-cost, high-precision electrical energy analyzer that can be used in homes, companies and
                            industries to monitor and analyze energy consumption.
                        </p>
                    </div>
                </div>
            )}
