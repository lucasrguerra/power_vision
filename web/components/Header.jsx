			...
			<>
				...
				<header className="bg-white shadow-xl px-4 py-4 text-center md:flex md:justify-between">
					...
					<div className="mt-2 md:mt-0">
						...
						<Button variant="contained" color={this.props.session ? "error" : "primary"} onClick={this.props.session ? () => signOut() : () => signIn()}>
							{this.props.session ? "Logout" : "Login"}
							{this.props.session ? <MdLogout className="ml-2" /> : <MdLogin className="ml-2" />}
						</Button>
					</div>
				</header>
			</>
